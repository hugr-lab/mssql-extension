...
| `mssql_browser_timeout_seconds` | 3 | SQL Server Browser UDP query timeout in seconds for named-instance resolution (spec 045) |
| `mssql_named_instance_resolution` | true | Enable SQL Server Browser (UDP 1434) resolution of `host\instance` connection strings (spec 045) |
