...
<!-- SPECKIT START -->
Active spec: 045-type-codec-consolidation. See specification at
`specs/045-type-codec-consolidation/spec.md`. Implementation plan
(research.md, data-model.md, contracts/, quickstart.md, tasks.md)
to be generated by `/speckit-plan` when ready to start work.
<!-- SPECKIT END -->
