...
| `mssql_utf8_collation` | VARCHAR | `Latin1_General_100_BIN2_UTF8` | Collation for created `varchar` columns (BIN2, as Fabric uses — binary comparison, so case- and accent-SENSITIVE); empty inherits the database default |
