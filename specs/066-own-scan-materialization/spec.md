...
(`CollectSinkCatalogs`) counts INSERT and COPY, not UPDATE/DELETE, so those
still defer to Finalize in a transaction — see
`../065-dml-pushdown-recon/revalidation-2026-09-17.md` § 3. Kept for the
problem statement and for D5, whose design spec 067 D3 consumes. (Original
status: Draft, step 1 of the v0.3.0 order, 2026-08-06.)
