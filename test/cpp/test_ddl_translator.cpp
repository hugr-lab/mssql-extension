...
void test_schema_ddl() {
    ...
    // CREATE SCHEMA
    ASSERT_EQ(MSSQLDDLTranslator::TranslateCreateSchema("test_schema"),
              "CREATE SCHEMA [test_schema];");

    // CREATE SCHEMA with special characters
    ASSERT_EQ(MSSQLDDLTranslator::TranslateCreateSchema("my]schema"),
              "CREATE SCHEMA [my]]schema];");

    // DROP SCHEMA
    ASSERT_EQ(MSSQLDDLTranslator::TranslateDropSchema("old_schema"),
...
void test_drop_table() {
    ...
    ASSERT_EQ(MSSQLDDLTranslator::TranslateDropTable("dbo", "users"),
              "DROP TABLE [dbo].[users];");

    // With special characters
    ASSERT_EQ(MSSQLDDLTranslator::TranslateDropTable("my]schema", "my]table"),
...
void test_alter_column_type() {
    ...
    std::string sql = MSSQLDDLTranslator::TranslateAlterColumnType(
        "dbo", "users", "age", LogicalType::BIGINT, true);
    ...
    // NOT NULL case
    sql = MSSQLDDLTranslator::TranslateAlterColumnType(
        "dbo", "users", "id", LogicalType::INTEGER, false);
...
void test_alter_column_nullability() {
    ...
    // Set NOT NULL
    std::string sql = MSSQLDDLTranslator::TranslateAlterColumnNullability(
        "dbo", "users", "email", LogicalType::VARCHAR, true);
    ...
    // Set NULL
    sql = MSSQLDDLTranslator::TranslateAlterColumnNullability(
        "dbo", "users", "phone", LogicalType::VARCHAR, false);
