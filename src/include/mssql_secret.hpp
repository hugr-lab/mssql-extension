...
constexpr const char *MSSQL_SECRET_TRUST_SERVER_CERTIFICATE = "trust_server_certificate";  // Optional, spec 074
constexpr const char *MSSQL_SECRET_HOST_NAME_IN_CERTIFICATE = "host_name_in_certificate";  // Optional, spec 074
